#!/usr/bin/env python3
"""
V4.1 Bengkulu GHI 1-hour-ahead forecasting experiments with leakage removed.
...
Outputs:
    outputs_v4_1_segmented_no_leak/ghi_1h_v4_metrics.csv
    outputs_v4_1_segmented_no_leak/ghi_1h_v4_segment_metrics.csv
    outputs_v4_1_segmented_no_leak/ghi_1h_v4_predictions_test.csv
    outputs_v4_1_segmented_no_leak/ghi_1h_v4_feature_importance.csv
    outputs_v4_1_segmented_no_leak/ghi_1h_v4_diagnostics.png
    outputs_v4_1_segmented_no_leak/models/*.joblib
"""
...
OUTPUT_DIR = Path("outputs_v4_1_segmented_no_leak")
...
ENGINEERED_FEATURES = [
    "solar_elev_sin", "solar_elev_sin_clip", "ghi_clear_proxy",
...
def main():
    ...
    print("V4.1 note: target_clear_proxy_now was removed because it leaked target_ghi_1h_ahead into features.")
    ...
    print("Best test models overall, leakage-free:")
